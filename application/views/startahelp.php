    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                ...
                <a href="#" class="mr-10 hover:text-gray-900">Donate</a>
                <a class="mr-10 hover:text-gray-900">My helps</a>
                <a class="mr-10 hover:text-gray-900">How it works</a>
                <a class="mr-10 hover:text-gray-900">Blogs</a>
                <a class="hover:text-gray-900">Contact us</a>
            </nav>
            <button
                class="inline-flex items-center bg-red-500 text-white border-0 m-1 py-1 px-3 focus:outline-none hover:bg-white-200 rounded-full text-base mt-4  md:mt-0">Login</button>
            <button
                class="inline-flex items-center bg-gray-100 text-red-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded-full text-base mt-4  md:mt-0">Start
                a Kanavu
            </button>
        </div>
            ...
            <footer class="footer mt-auto h-256 w-full bg-red-600 py-3 text-white">
                ...
                <div class="social-icons flex justify-center text-center mt-4">
                    ...
                    <a href="https://twitter.com/" target="_blank">
                        <img src="<?php echo base_url('/assets/img/linkedin-in.svg'); ?>" alt="Twitter Logo"
                            class="w-6 h-6 mr-2">
                    </a>
