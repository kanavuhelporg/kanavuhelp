            ...
            <div class="col-lg-2 col-12 border-bottom ps-gray py-3">
                <div class="ps-logo">
                    <button type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSidebar"
                        aria-controls="offcanvasSidebar" class="ham-menu ms-4 border-0 bg-transparent">
                ...
                <div class="col-lg-3 d-none d-lg-flex align-items-baseline justify-content-evenly">
                    ...
                    <!-- <span class="d-flex justify-content-center">
                        ...
                        <div style="width:30px;height:30px;background-color:red;color:white;margin-top:-15px;" class="rounded-circle d-flex justify-content-center align-items-center">
                            <?php if ($this->session->userdata('unverifiedtransactions') > 0) {
                                echo $this->session->userdata("unverifiedtransactions");
                            } ?>
                        </div>
                    </span> -->
                </div>
        ...
        <div class="row" style="height: 100vh;"><!----------main-navbar----------->
                ...
                <div style="overflow:auto" class="mt-3 px-4">
                    ...
                    <div class="row mb-3 align-items-center">
                        <div class="col-md-4 position-relative">
                            ...
                            <button id="clear-filter" class="btn position-absolute end-0 top-50 translate-middle-y"
                        ...
                        <div class="col-md-8 d-flex align-items-center gap-2 mt-2 mt-md-0">
                            ...
                            <input type="date" id="filter-date" class="form-control form-control-sm"
                                style="width: 160px;">
                            <button id="bulk-delete-selected-btn" onclick="deleteSelectedCauses()"
                            ...
                            <tbody id="causes-tbody">
                                <?php if (!empty($fundraisers)): ?>
                                    <?php foreach ($fundraisers as $index => $donation): ?>
                                        <tr
                                            data-date="<?= !empty($donation->created_at) ? date('Y-m-d', strtotime($donation->created_at)) : ''; ?>">
                                            <td><input type="checkbox" class="cause-select-chk" value="<?= $donation->id; ?>"
                                                    data-status="<?= $donation->verified == 1 ? 'Yes' : 'No'; ?>"
                                                    style="cursor: pointer;"></td>
                                            <td><?= $index + 1; ?></td>
                                            <td>
                                                <button data-bs-toggle="modal" data-bs-target="#viewdocuments"
                                                    ...
                                                    <?php if ($donation->is_runforcause == 'yes'): ?>
                                                        <span class="badge bg-danger text-white ms-1"
                                                            style="font-size: 0.65rem; padding: 2px 5px; font-weight: 600;">
                                            ...
                                            <td class="d-flex">
                                                <button type="button" class="btn btn-sm btn-primary open-cause-modal text-white"
                                                    toggle="tooltip" title="View/Edit the Cause" data-id="<?= $donation->id; ?>"
                                                    data-mode="view">
                                                    <i class="fa fa-eye"></i>
                                                </button>&nbsp;&nbsp;
                                                <button type="button" class="btn btn-sm btn-success ms-1" toggle="tooltip"
                                                    title="Update Progress" data-bs-toggle="modal"
                                                    data-bs-target="#updateProgressModal"
                                                    onclick="openUpdateProgressModal(<?= $donation->id ?>)">
                                                    <i class="fa fa-upload"></i>
                                                </button>&nbsp;&nbsp;
                                                <button class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#sendmail" toggle="tooltip"
                                                    title="Send email after verification" onclick="setUrl(
                                                    '<?= $donation->email ?>',
                                                    '<?= $donation->user_id ?>',
                                                    '<?= $donation->created_by ?>',
                                                ...
                                                <?php if ($this->session->userdata('adminName')): ?>
                                                    <?php if ($donation->priority == 0): ?>
                                                        <button class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                            data-bs-target="#priorityModal" toggle="tooltip"
                                                            title="want to set priority for this cause"
                                                            onclick="setPriorityId(<?= $donation->id ?>)">
                                                            Insert Priority
                                                        </button>

                                                        <button class="btn btn-warning btn-sm no-priority-btn" style="display: none;"
                                                            toggle="tooltip" title="want to remove priority for this cause"
                                                            onclick="setNoPriority(<?= $donation->id; ?>)">No Priority</button>
                                                    <?php else: ?>
                                                        <button class="btn btn-info btn-sm insert-priority-btn" style="display: none;"
                                                            toggle="tooltip" title="want to set priority for this cause"
                                                            data-toggle="modal" data-target="#priorityModal"
                                                            onclick="setPriorityId(<?= $donation->id; ?>)">Insert Priority</button>
                                                        <button class="btn btn-warning btn-sm no-priority-btn" toggle="tooltip"
                                                            title="want to remove priority for this cause"
                                                            onclick="setNoPriority(<?= $donation->id; ?>)">No Priority</button>
                                                    <?php endif; ?>
                                                    &nbsp;&nbsp;
                                                    <button type="button" class="btn btn-sm btn-secondary manual-complete-btn"
                                                        toggle="tooltip" title="Manually complete the cause" data-bs-toggle="modal"
            ...
            <style>
                .tooltip-inner {
                    ...
                    /* controls wrapping like screenshot */
...
?>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div contenteditable style="min-height:50px;max-height:max-content;outline:none;"
                                class="w-100 border p-1" name="sendemail" id="causestatus">
                        ...
                        <div class="modal-body">
                            <form id="priorityForm">
                                ...
                                <div class="form-group">
                                    <label for="priorityValue">Priority Value (1-8 or 0 for No Priority Higher numbers
                                        (e.g 8) first priority)</label>
                                    <input type="number" class="form-control" id="priorityValue" name="priority" min="0"
                                        max="8" required>
                                </div>
                    ...
                    <form id="causeForm" action="<?php echo base_url('admin/update_cause'); ?>" method="POST"
                        ...
                        <div class="modal-content">
                            <div class="modal-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex align-items-center">
                                    <button type="button" class="btn btn-success btn-sm text-white shadow-sm me-2"
                                        id="editBtnModal">
                                        <i class="fa fa-edit"></i> Edit
                                    </button>
                                    <button type="button" class="btn btn-danger btn-sm shadow-sm me-2"
                                        id="deleteBtnModal">
                            ...
                            <div class="modal-body" style="max-height: 80vh; overflow-y: auto;">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <label class="form-label small">Category <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="category" id="field_category" class="form-control"
                                            required>
                                        <small id="field_category_err" class="text-danger"
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input type="text" name="age" id="field_age" class="form-control" maxlength="3"
                                            oninput="this.value = this.value.replace(/[^0-9]/g, ''); if(this.value !== '' && parseInt(this.value) > 120) this.value = '120'; if(this.value === '0') this.value = '';"
                                            required>
                                        <small id="field_age_err" class="text-danger" style="display:none;"></small>
                                    </div>
                                    <div class="col-md-4">
                                        <label class="form-label small">Location <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="location" id="field_location" class="form-control"
                                            oninput="this.value = this.value.replace(/[^a-zA-Z\s,.\-\u0B80-\u0BFF]/g, '')"
                                            required>
                                        <small id="field_location_err" class="text-danger"
                                            style="display:none;"></small>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small">Form Selection Text <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="form_selected_text" id="field_form_text"
                                            class="form-control"
                                            oninput="this.value = this.value.replace(/[^a-zA-Z\s\u0B80-\u0BFF]/g, '')"
                                            required>
                                        <small id="field_form_text_err" class="text-danger"
                                            style="display:none;"></small>
                                    </div>
                                </div>
                                ...
                                <div class="row g-3 mb-3">
                                    ...
                                    ">
                                        <small id="field_eventname_err" class="text-danger" style="display:none;">Event
                                            Name cannot be purely numeric. Please include letters.</small>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="eventdistancekm" id="field_eventdistancekm"
                                            class="form-control"
                                            oninput="this.value = this.value.replace(/[^0-9.]/g, '')">
                                    </div>
                                    <div class="col-md-12">
                                        <label class="form-label small">Event Location</label>
                                        <input type="text" name="eventlocation" id="field_eventlocation"
                                            class="form-control"
                                            oninput="this.value = this.value.replace(/[^a-zA-Z\s\u0B80-\u0BFF]/g, '')">
                                    </div>
                                </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-3">
                                        <label class="form-label small">Goal Amount <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="amount" id="field_amount" class="form-control"
                                    ...
                                    <div class="col-md-3">
                                        <label class="form-label small">End Date <span
                                                class="text-danger">*</span></label>
                                        <input type="date" name="end_date" id="field_end_date" class="form-control"
                                            required>
                                        <small id="field_end_date_err" class="text-danger"
                                            style="display:none;"></small>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="created_by" id="field_created_by" class="form-control"
                                            oninput="this.value = this.value.replace(/[^a-zA-Z\s\-\u0B80-\u0BFF]/g, '')"
                                            required>
                                        <small id="field_created_by_err" class="text-danger"
                                            style="display:none;"></small>
                                    </div>
                                    <div class="col-md-2">
                                        <label class="form-label small">Is Fill</label>
                                        <input type="text" name="isFill" id="field_isFill" class="form-control" readonly
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="Cause_video" class="form-control"
                                            accept="video/mp4, video/avi, video/quicktime, video/webm, video/x-matroska, video/x-m4v"
                                            onchange="validateAdminFile(this, 'video')">
                                        <small id="label_video_file" class="text-muted"></small>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small">Cause Video English (Upload)</label>
                                        <input type="hidden" name="Cause_video_english_old"
                                            id="field_video_file_eng_old">
                                        <input type="file" name="Cause_video_english" class="form-control"
                                            accept="video/mp4, video/avi, video/quicktime, video/webm, video/x-matroska, video/x-m4v"
                                            onchange="validateAdminFile(this, 'video')">
                                        <small id="label_video_file_eng" class="text-muted"></small>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small">Cause Video Link <span
                                                class="text-danger">*</span></label>
                                        <input type="url" name="Cause_video_link" id="field_video_link"
                                            class="form-control"
                                            placeholder="https://youtube.com/... or https://youtu.be/..."
                                            onblur="validateVideoLink(this)" required>
                                        <small class="text-danger" id="field_video_link_err" style="display:none;">Only
                                            video links (YouTube, Vimeo, Dailymotion, etc.) are allowed.</small>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label small">Original Cause Video Link <span
                                                class="text-danger">*</span></label>
                                        <input type="url" name="Cause_video_link_eng" id="field_video_link_eng"
                                            class="form-control"
                                            placeholder="https://youtube.com/... or https://youtu.be/..."
                                            onblur="validateVideoLink(this)" required>
                                        <small class="text-danger" id="field_video_link_eng_err"
                                            style="display:none;">Only video links (YouTube, Vimeo, Dailymotion, etc.)
                                            are allowed.</small>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary shadow-sm" id="submitBtn">Update Database
                                    Record</button>
                            </div>
                        </div>
                    </form>
        ...
        `;
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex align-items-center" id="progressModalActions" style="display:none;">
                                <button type="button" class="btn btn-success btn-sm text-white shadow-sm me-2"
                                    id="editBtnProgressModal" style="display:none;">
                                    <i class="fa fa-edit"></i> Edit
                                </button>
                                <button type="button" class="btn btn-danger btn-sm shadow-sm me-2"
                                    id="deleteBtnProgressModal" style="display:none;">
                                    <i class="fa fa-trash"></i> Delete
                                </button>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                            </div>
                        ...
                        <div class="modal-body">
                            ...
                            <form id="updateProgressForm" method="post"
                                action="<?= base_url('kanavuhelp/updateprogressdata') ?>" enctype="multipart/form-data">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="progress_description" id="progress_description"
                                            class="form-control"></textarea>
                                        <div id="description_error" class="text-danger mt-1"
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="document_one" id="document_one" accept="image/*"
                                            class="form-control">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="document_two" id="document_two" accept="image/*"
                                            class="form-control">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="document_three" id="document_three" accept="image/*"
                                            class="form-control">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="document_four" id="document_four" accept="image/*"
                                            class="form-control">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" name="document_five" id="document_five" accept="image/*"
                                            class="form-control">
          ...
          <div class="row my-3">
            ...
            <div class="col-md-8">
              <input type="file" name="progress_video" accept="video/mp4" class="form-control">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="progress_embed_video_link"
                                            id="progress_embed_video_link" class="form-control">
                                        <div id="embed_video_error" class="text-danger mt-1"
                                            style="display: none; font-size: 13px;"></div>
                                    </div>
                                </div>
            ...
            <div id="manualCompleteModal" class="modal fade" tabindex="-1" aria-labelledby="manualCompleteModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <form id="manualCompleteForm">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="completionToggle"
                                    ...
                                    <small class="text-muted d-block mt-2">
                                        <i class="fa fa-info-circle"></i> This will set the raised amount equal to the
                                        goal amount.
                                    </small>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="completionReason" name="completion_reason"
                                        rows="4" maxlength="100"
                                        placeholder="Enter the reason for completing this cause manually (letters & spaces only, max 100 chars)..."
                                        required></textarea>
                                    <small class="text-muted">Provide a brief explanation for manually completing this
                                        cause (letters and spaces only, maximum 100 characters).</small>
                                </div>
                            </form>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="button" class="btn btn-danger" id="manualCompleteSubmitBtn">Complete
                                Cause</button>
                        </div>
                    </div>
                </div>
