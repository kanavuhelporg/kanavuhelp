...
<body>
          ...
          <form id="donationForm" method="POST" action="<?= base_url('kanavuhelp/processDonation') ?>"
            ...
            <div class="card border-0 shadow-sm mb-3" style="border-radius: 12px;">
              <div class="card-body">
                ...
                <small class="text-muted d-block mt-2">Secure Gateway is the default. Manual UPI is still available if you want to collect payment outside the gateway.</small>
              </div>
            </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      const cityInput = document.getElementById('donorcity') || document.getElementById('city');
