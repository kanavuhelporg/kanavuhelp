...
$route['updateUser'] = 'profile/updateUser';
...
// $route['admin/delete_unused_users'] = 'admin/delete_unused_users';
$route['admin/delete_user'] = 'admin/delete_user';
// $route['admin/delete_unverified_causes'] = 'admin/delete_unverified_causes';
$route['admin/delete_selected_transactions'] = 'admin/delete_selected_transactions';
$route['admin/delete_selected_causes'] = 'admin/delete_selected_causes';
...
$route['register'] = 'kanavuhelp/register';
$route['profile_view'] = 'profile/viewProfile';
$route['login'] = 'kanavuhelp/login';
